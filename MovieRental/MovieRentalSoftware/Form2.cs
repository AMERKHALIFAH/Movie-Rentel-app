...
namespace MovieRentalSoftware
{
    public partial class Form2 : Form
    {
        ...
        private void LoadRentedMoviesData()
        {
            try
            {
                int currentClientId = LoginForm.LoggedInClientId;
                ...
                Movie_Rental_ManagementDataSet.RENTAL_DETAILDataTable filteredTable = new Movie_Rental_ManagementDataSet.RENTAL_DETAILDataTable();
                foreach (Movie_Rental_ManagementDataSet.RENTAL_DETAILRow row in rentalDetailDataTable.Rows)
                {
                    if (row.CLIENT_ID == currentClientId)
                    {
